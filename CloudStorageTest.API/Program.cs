...
{
    var clientId = builder.Configuration.GetValue<string>("CloundStorage:ClientId");
    var clientSecret = builder.Configuration.GetValue<string>("CloundStorage:ClientSecret");
